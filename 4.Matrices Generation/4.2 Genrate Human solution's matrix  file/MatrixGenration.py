...
base_dir = os.getcwd()
code_folder = os.path.join(base_dir, 'code_solutions-human')  #folder  that has  code   solutions in .py
csv_file_path = os.path.join(base_dir, 'code_metrics_human.csv')  # output file  
