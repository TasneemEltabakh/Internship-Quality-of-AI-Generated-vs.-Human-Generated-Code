...
base_dir = os.getcwd()
code_folder = os.path.join(base_dir, 'code-climate-analysis-code_prep')
csv_file_path = os.path.join(base_dir, 'code_metrics.csv')
...
with open(csv_file_path, 'w', newline='') as csvfile:
    fieldnames = [
        'Filename', 'Cyclomatic Complexity', 'Halstead Metrics', 'Maintainability Index',
        'Source Lines of Code (SLOC)', 'Comments Ratio', 'Number of Parameters',
        'Afferent Coupling', 'Efferent Coupling', 'Instability', 'Syntax Errors'
    ]
